...
int main() {
  ...
  for (int ii = 0; ii < total; ii++) {
    ...
    cout << " -->" << image_points_seq[ii][1].x;
    cout << " -->" << image_points_seq[ii][1].y;

    cout << " -->" << image_points_seq[ii][2].x;
    cout << " -->" << image_points_seq[ii][2].y;
  }
  cout << "角点提取完成！\n";
  ...
  *************************************************************************/
  ...
  for (int i = 0; i != image_count; i++) {
    ...
    filePath += ".bmp";
    Mat imageSource = imread(filename_vec[i]);
